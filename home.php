...
<html>
    ...
    <body style="background-color: aliceblue">
        ...
        <div class="row" style="background-color:skyblue">
         ...
         <img src="carhd7.jpg" height="400px" width="700"></div>
         <div class="col-sm-6">
            <img src="carhd3.gif" height="400px" width="600"/></div>
            <!--<img src="quotecar4.png" height="350px" width="400">-->
            </div>
        ...
        <div class="row" style="background-color:skyblue">
         ...
         <img src="carquote11.jpg" height="400px" width="1250"></div>
     </div>
