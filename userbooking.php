...
$link=mysqli_connect(HOST,USERNAME,PASSWORD,DBNAME);
  $qry="insert into booking(logid,carname,bookingdate,pickuptime,days,location) 
  values('$logid','$carname','$bookingdate','$pickuptime','$days','$location')";
...
//$link1=mysqli_connect(HOST,USERNAME,PASSWORD,DBNAME);
  ...
  location='$location' and pickuptime='$pickuptime'"; 
  ...
  <div id="box">
    ...
    <table>
     ...
     <!--<tr>
      ...
      <td>Pick up time </td>
        <td><input type="time" placeholder="hh:mm " name="pickuptime" required/></td>
      </tr>
             <td>No of days</td>
