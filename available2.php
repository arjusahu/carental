...
//echo "<br>";
      $l=$r['price3'];
       echo "<input type='submit' value='$l' name='price'/>";
...
//echo "<br>";
         $p=$r['name'];
         echo "<a href='userbooking.php?id=$p'><font color='white'><input type='button' value='BOOK NOW'?id='$r[carid]'' name='book' style='background-color:purple;height:30px;width:90px'/></font></a>";
