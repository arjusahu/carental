...
//$pwd=$_GET['txt_pwd'];
  ...
  $qry="select * from admin where logid='$logid' and pwd='$pwd'";
...
<html>
    ...
    <body style="background-color: aliceblue">
        ...
        include ("header.php");
        ?>
	<div class="row"  style="background-image:url('carr.jpg'); width: 1400px;height:600px">
...
<br>
<br><font color="white"><input type="submit" name="btn_reg" value="log in" style="background-color:purple;width:100px"></font>
<!--<br>
<a href=""><font color="red" >remember me</font><br>-->
<?php
echo $msg;
?>
</div>
